                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex flex-column flex-sm-row gap-1 justify-content-center">
                                    <a href="{{ route('institusi.edit', $institusi) }}" class="btn btn-sm btn-warning" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('institusi.destroy', $institusi) }}" method="POST" onsubmit="return confirm('Hapus data ini?')">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="accordion mb-4" id="infoAccordion">
        <div class="accordion-item border-0 shadow">
            <h2 class="accordion-header" id="headingInfo">
                <button class="accordion-button collapsed bg-primary text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapseInfo" aria-expanded="false" aria-controls="collapseInfo">
            ...
            <div id="collapseInfo" class="accordion-collapse collapse" aria-labelledby="headingInfo" data-bs-parent="#infoAccordion">
                <div class="accordion-body bg-light">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-4">
                                <h5 class="text-primary"><i class="fas fa-user-tie me-2"></i>Pejabat Pembuat Komitmen (PPK)</h5>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item bg-light">Menandatangani dan mengendalikan kontrak pengadaan</li>
                                    <li class="list-group-item bg-light">Mengawasi pelaksanaan pekerjaan penyedia barang/jasa</li>
                                    <li class="list-group-item bg-light">Memeriksa hasil pekerjaan dan menguji kebenaran tagihan</li>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item bg-light">Melaksanakan pemilihan penyedia untuk paket pengadaan tertentu (nilai ≤ 200 juta)</li>
                                    <li class="list-group-item bg-light">Membuat dan menetapkan dokumen pemilihan</li>
                                    <li class="list-group-item bg-light">Menunjuk penyedia berdasarkan hasil evaluasi</li>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item bg-light">Mengelola dana kas kecil dan pembayaran berdasarkan SPM</li>
                                    <li class="list-group-item bg-light">Melakukan pencatatan transaksi keuangan negara secara akuntabel</li>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item bg-light">Digunakan untuk kebutuhan operasional seperti ATK, honorarium, sewa, konsumsi, dan jasa lainnya</li>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item bg-light">Digunakan untuk pengadaan barang atau aset bernilai ekonomis dan tahan lama (lebih dari 1 tahun)</li>
                                    <li class="list-group-item bg-light">Contoh: komputer, alat laboratorium, kendaraan, dan gedung</li>
                                    <li class="list-group-item bg-light">Menambah nilai aset negara dan dicatat dalam neraca pemerintah</li>
                                </ul>
                            </div>
                        </div>
                    </div>
