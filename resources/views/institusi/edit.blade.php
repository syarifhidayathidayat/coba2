            ...
            <form action="{{ route('institusi.update', $institusi) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="no_telp" class="form-control" value="{{ old('no_telp', $institusi->no_telp) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Fax</label>
                        <input type="text" name="fax" class="form-control" value="{{ old('fax', $institusi->fax) }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tanggal_sp_dipa" class="form-control" value="{{ old('tanggal_sp_dipa', $institusi->tanggal_sp_dipa) }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="no_sk_pejabat" class="form-control" value="{{ old('no_sk_pejabat', $institusi->no_sk_pejabat) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tanggal SK Pejabat</label>
                        <input type="date" name="tanggal_sk_pejabat" class="form-control" value="{{ old('tanggal_sk_pejabat', $institusi->tanggal_sk_pejabat) }}">
                    </div>
                </div>
