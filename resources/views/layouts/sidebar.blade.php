<div class="sidebar sidebar-light sidebar-fixed" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
      ...
      @hasanyrole('admin')
        <li class="nav-item"><a class="nav-link" href="{{ route('pegawai.index') }}"><i class="fas fa-user-tie nav-icon"></i> Pegawai</a></li>
      @endhasanyrole
      ...
      <li class="nav-group">
        ...
        <ul class="nav-group-items">
          @hasanyrole('admin|Pejabat-Pengadaan53')
            <li class="nav-item"><a class="nav-link" href="{{ route('penempatan.index') }}">Penempatan Barang</a></li>
          @endhasanyrole
          @hasanyrole('admin')
            <li class="nav-item"><a class="nav-link" href="{{ route('menu.index') }}">Role User</a></li>
          @endhasanyrole
          @hasanyrole('admin|Pejabat-Pengadaan53')
            <li class="nav-item"><a class="nav-link" href="{{ route('institusi.index') }}">Institusi & Pejabat</a></li>
          @endhasanyrole
          @hasanyrole('admin')
