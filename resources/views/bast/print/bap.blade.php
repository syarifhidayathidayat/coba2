...
<body>
    ...
    <div class="content">
            ...
            <li>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">:
                        {{ $jenisAkun == '52' ? $institusi->nama_ppk_52 ?? '-' : $institusi->nama_ppk_53 ?? '-' }}
                    </span>
                </div>
                <div class="info-item">
        ...
        <ol style="padding-left: 20px;">
            <li>
                ...
                <div class="info-item"><span class="info-label">Penyedia</span><span class="info-value">:
                        {{ $bast->sp->penyedia->nama_penyedia ?? '-' }}</span></div>
                <div class="info-item"><span class="info-label">No SP</span><span class="info-value">:
                        {{ $bast->sp->nomor_sp ?? '-' }}</span></div>
                <div class="info-item"><span class="info-label">Hasil Pemeriksaan</span><span class="info-value">:
                        Terlampir</span></div>
            </li>
            <li style="margin-top: 2px;">
                Berdasarkan pemeriksaan tersebut, Penyedia/Pelaksana Pekerjaan yang bersangkutan telah menyelesaikan
                seluruh pelaksanaan pekerjaan dengan baik, sesuai dengan kontrak pekerjaan dengan segala perubahan dan
                kelengkapannya seperti dimaksud dalam Surat Pesanan.
            </li>
            <li style="margin-top: 2px;">
                Berdasarkan Surat Pesanan tersebut diatas selanjutnya dapat diadakan Serah Terima atas seluruh pekerjaan
                {{ $bast->sp->nama_paket ?? '-' }} Tahun anggaran {{ date('Y') }}.
            </li>
        </ol>
        <p>Demikian Berita Acara ini dibuat dan ditanda tangani di Banjarbaru pada tanggal tersebut di atas, dalam
            rangkap 3 (Tiga) untuk dipergunakan seperlunya.</p>
    ...
    <div class="footer">
        <div class="signature">
            ...
            <br><br><br><br>
            <div> <strong>{{ $jenisAkun == '52' ? $institusi->nama_ppk_52 ?? '-' : $institusi->nama_ppk_53 ?? '-' }}</strong> </div>
